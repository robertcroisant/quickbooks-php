...
class QuickBooks_WebConnector_Queue
{
     ...
     */
    public function __construct($dsn_or_conn, $user = null, $config = [])
    {
    ...
    public function recurring(
        ...
        if ($this->_driver) {
            ...
            */
            ...
            return $this->_driver->recurEnqueue($user, $run_every, $action, substr($ident, 0, 40), $replace, $priority,
                $extra, $qbxml);
        }
     ...
     * @param string  $type The type that will be used for polymorphic relationships.
     *
     * @return boolean
     */
    public function enqueue(
        ...
        if ($this->_driver) {
            ...
            */
            ...
            return $this->_driver->queueEnqueue($user, $action, substr($ident, 0, 40), $replace, $priority, $extra,
                $qbxml, $type);
        }
